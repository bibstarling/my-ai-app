...
export const portfolioData = {
  ...
  projects: [
    ...
    {
      id: 'continuous-discovery-skillshare',
    ...
    {
      id: 'productboard-implementation-voxy',
      title: 'Implementation and Rollout of Productboard',
      company: 'Voxy',
      cardTeaser: 'Led the implementation and rollout of Productboard at Voxy to improve product discovery, prioritization, and cross-functional alignment, owning the initiative from evaluation through adoption.',
      outcome: 'Centralized product feedback; improved prioritization transparency; stronger cross-functional alignment; increased decision clarity as organization scaled.',
      tags: ['Product Operations', 'Discovery Systems', 'Feedback Taxonomy', 'Change Management', 'Cross-Functional Enablement', 'Tool Implementation'],
      details: [
        {
          paragraphs: [
            'I led the implementation and rollout of Productboard at Voxy to improve product discovery, prioritization, and cross-functional alignment, owning the initiative from evaluation through adoption.',
            'As Voxy scaled, product feedback, ideas, and requests were spread across documents, tools, and conversations. This made it difficult to prioritize effectively, track decisions, and communicate product direction consistently across teams.',
            'The challenge was not a lack of insight. It was lack of structure and visibility.',
            'This work reframed product tooling from a reporting mechanism into a decision-support system.',
          ],
        },
        {
          heading: 'Discovery and problem framing',
          paragraphs: [
            'I led discovery to understand how feedback flowed across the organization and where it broke down. This included reviewing existing intake processes, talking with stakeholders across teams, and identifying gaps in prioritization and transparency.',
            'Key issues included:',
          ],
          list: [
            'Feedback lived in multiple disconnected systems',
            'Prioritization decisions were hard to trace back to user input',
            'Teams lacked shared visibility into what was being worked on and why',
            'Product context was lost as initiatives moved from discovery to delivery',
          ],
        },
        {
          paragraphs: [
            'The opportunity was to centralize insight and create a single source of truth for product decisions.',
          ],
        },
        {
          heading: 'Product definition and delivery',
          paragraphs: [
            'Based on these insights, I led the rollout of Productboard as the primary system for capturing user feedback, mapping it to features, and informing prioritization.',
            'This included: Defining feedback taxonomy and ownership; Integrating Productboard into existing workflows; Training product and partner teams on usage; Establishing clear expectations for how insights informed roadmaps.',
            'The focus was on adoption and behavior change, not just tool installation.',
          ],
        },
        {
          heading: 'Measurement and impact',
          paragraphs: [
            'Success was measured through adoption, consistency of use, and improvements in decision clarity.',
            'Following rollout: Product feedback was centralized and easier to analyze; Prioritization became more transparent and defensible; Cross-functional alignment improved around product direction; Teams spent less time reconciling conflicting inputs.',
          ],
        },
        { heading: 'Skills and capabilities applied', list: ['Product discovery systems', 'Feedback taxonomy and governance', 'Change management', 'Cross-functional enablement', 'Product operations'] },
        { heading: 'Outcome', paragraphs: ['The Productboard rollout improved how Voxy made product decisions by creating a shared, structured foundation for discovery and prioritization. It increased clarity, alignment, and confidence across teams as the organization scaled.'] },
      ],
    },
